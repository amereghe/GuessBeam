function [alphaFit,betaFit,emiGfit,phisFit,alphaPrp,betaPrp,emiGprp,phisPrp,sigZ,sigZP,profiles]=...
    ...
    for iIter=1:nIter
        ...
        MyContours=ExpandMat(MyContours,SampleEllypse(alphaFit(iIter),betaFit(iIter),emiGfit(iIter)));
        ...
        MyContours=ExpandMat(MyContours,SampleEllypse(alphaPrp(iIter),betaPrp(iIter),emiGprp(iIter)));
